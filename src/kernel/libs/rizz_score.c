...
int wordCheck(char * str) {
    char bad[45][20] = {
        "ass","penis","piss","cum","boobs","boob","porn","booty","ass","titty","suck","balls","head","nigga","n","word","slur","bitch","slur","klaudussy","kussy","hell","hoe","hoes","astros","texas","boston","poop","poopy","javascript","asshole","butthole","wsg","bbg","shlong","badonkadonk","badonkidonk","fuck","fucking","mommy","daddy","zaddy","papi"
    };
    char good[40][10] = {
